...
You may see mention of `auto_explain_threshold_in_seconds` online but it was removed in Rails 4

```ruby
# You can run explain on queries generated by ActiveRecord
User.where(:id => 1).joins(:posts).explain
# WARNING: this will actually run your query
# details in https://guides.rubyonrails.org/active_record_querying.html#running-explain
```